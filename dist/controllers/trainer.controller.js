...
const createTrainer = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const trainer = yield TrainerService.createTrainer(name, email);
...
const getAllTrainers = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const trainers = yield TrainerService.getAllTrainers();
...
const getTrainerById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const trainer = yield TrainerService.getTrainerById(id);
